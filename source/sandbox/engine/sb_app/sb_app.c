/*==============================================================================================
    ...
    sandbox/engine/sb_app/sb_app.c -- Menu-driven feature tests for the engine/app layer.
...
enter_mode( test_mode_t m )
{
    ...
    switch ( m )
    {
        ...
        case MODE_MULTI_WIN:
        {
            ...
            if ( !app()->window_is_valid( g_extra_win ) )
            {
                g_extra_win = app()->window_open( "sb_app: extra", 120, 80, 480, 320,
                                                      APP_WIN_DEFAULT );
...
main( int argc, char** argv )
{
    ...
    g_main_win = app()->window_open( "sb_app", 0, 0, 0, 0, APP_WIN_DEFAULT );
