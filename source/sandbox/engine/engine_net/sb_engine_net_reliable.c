/*==============================================================================================
    ...
    sb_engine_net_reliable.c -- Layer 2/4 tests: reliable-ordered delivery, fragmentation,
    and stats under a hostile simulated wire (loss + duplication + jitter, both directions).

    Uses the pump_ctx_t helpers from sb_engine_net_conn.c (unity-included before this file).
