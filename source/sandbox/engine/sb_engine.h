...
4. APP: platform app window, raw input, gpu surface
    ...
    app/
        ...
        win32_gpu_surface.c
        linux_*.c
        app_module.c  mod_api_t wrapper
...
3. MOD: module system registry, hot-reload, dep sort
    ...
    ** Peer to core, not inside it **
    ...
    module_sys/
        ...
        mod_api.h       contract every module implements
...
3. CORE: sid, log, alloc, cvar, assert 
    ...
    core/
        ...
        core_module.c  mod_api_t wrapper, service_register() call
...
2. SYS: platform sys dll load, file watch, clock, file io, thread primitives
    ...
    sys/
        ...
        file_watch.h       sys_filewatch_init, sys_filewatch_poll, sys_filewatch_shutdown
        file_watch_win32.c
        file_watch_linux.c
