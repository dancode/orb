/*==============================================================================================
    ...
    Constituents, in include order:
        ...
        test_font.c  -- the two-tier glyph lookup: ASCII dense tier, ext binary search, '?' miss;
                        the .orb_font byte contract (reference section, exact length)
...
main( int argc, char* argv[] )
{
    ...
    test_register( "quad_instance_pack",  test_quad_instance_pack );
    test_register( "phase_anchor",        test_phase_anchor );
