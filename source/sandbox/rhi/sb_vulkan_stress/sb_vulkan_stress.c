/*==============================================================================================
    ...
    sandbox/rhi/sb_vulkan_stress/sb_vulkan_stress.c -- Multi-context RHI synchronization stress test.
...
f4_init( void )
{
    ...
    rhi_vertex_attrib_t attribs[ 3 ] = {
        ...
        { .binding = 0, .location = 2, .offset = 16, .format = RHI_VERTEX_FORMAT_UNORM8X4 },
    };
