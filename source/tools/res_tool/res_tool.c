/*==============================================================================================
    ...
    a C table of canonical name + id pairs:
...
write_table( const char* out_path, const char* symbol )
{
    ...
    fprintf( f, "    harvested from %d source file(s), with its id.  A trailing slash marks a\n", g_file_count );
    fprintf( f, "    subtree.  Registered with the resource catalogue when the image's module\n" );
    fprintf( f, "    descriptor comes online (MOD_RES_TABLE).  */\n\n" );
