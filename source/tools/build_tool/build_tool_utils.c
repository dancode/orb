...
cmd_append( cmd_buf_t* b, const char* fmt, ... )
{
    ...
    /*  vsnprintf returns < 0 on encoding errors. We can't tell how much 
        was written, so the safe move is to treat the buffer as toast
    ...
    {
        /*  Overflowed. Mark truncated and pin size at the null-terminator
...
/*==============================================================================================
    -- Command -- Handle spill event on overflow to response file.
