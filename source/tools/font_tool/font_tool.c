/*==============================================================================================
    ...
    glyph bitmaps into a texture atlas with stb_rect_pack, and writes either:
        ...
        .c         -- C source file with a bit-packed glyph table matching
                      the bit_font_def_t format in imgui_font.h;
                      drop the output into imgui_font_bmp.c as a new built-in bit font.
...
/*==============================================================================================
    ...
    initializer compatible with imgui_font_bmp.c.  Each row is packed with
                ...
                int32_t ascent, int32_t descent, uint32_t raw_count )
{
    ...
    fprintf( f, "    Drop into imgui_font_bmp.c and add a bmp_font_t instance.\n" );
    fprintf( f, "------------------------------------------------------------------*/\n\n" );
