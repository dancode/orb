...
/*============================================================================================*/
/* rs is always statically linked into the host — REF_STATIC is set by CMake globally. */
...
#else
    #define MOD_USE_RS    MOD_DEFINE_API_PTR( ref_api_t, ref )
    #define MOD_FETCH_RS  MOD_FETCH_API( ref_api_t, ref )
#endif
