/*==============================================================================================
    ...
    The executable's own table -- every name its sources and statically linked libraries
    reference -- is generated by the build as g_host_res_table (obj/<exe>/<exe>_res_table.c)
    and carried by res's own module descriptor, so loading "res" is what registers it.  An
    unresolved g_host_res_table at link time means the exe was linked without the build
    running res_tool over it.
...
/*==============================================================================================
    ...
    g_host_res_table is the executable image's generated name table (see the file header);
    the descriptor points its res_table at it.
==============================================================================================*/

extern const res_table_t g_host_res_table;
