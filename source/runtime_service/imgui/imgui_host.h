...
void imgui_draw_close( imgui_rect_t box, u32 col );
void imgui_draw_arrow_pointing_at( f32 tx, f32 ty, f32 half, imgui_dir_t dir, u32 col );
void imgui_draw_chevron( imgui_rect_t box, imgui_dir_t dir, f32 thickness, u32 col );
void imgui_draw_plus_minus( imgui_rect_t box, bool plus, f32 thickness, u32 col );
void imgui_draw_frame( imgui_rect_t box, u32 col_bg, u32 col_border, f32 border );
void imgui_draw_round_rect( imgui_rect_t box, f32 r_tl, f32 r_tr, f32 r_br, f32 r_bl, bool filled, f32 thickness, u32 col );
void imgui_draw_ngon( f32 cx, f32 cy, f32 r, u32 sides, f32 rot, bool filled, f32 thickness, u32 col );
void imgui_draw_circle( f32 cx, f32 cy, f32 r, bool filled, f32 thickness, u32 col );
void imgui_draw_arc( f32 cx, f32 cy, f32 r, f32 a0, f32 a1, f32 thickness, u32 col );
void imgui_draw_pie( f32 cx, f32 cy, f32 r, f32 a0, f32 a1, u32 col );
...
void imgui_draw_checker( imgui_rect_t box, f32 cell, u32 col_a, u32 col_b );
void imgui_draw_hatch( imgui_rect_t box, f32 spacing, f32 thickness, u32 col );
void imgui_draw_gradient( imgui_rect_t box, u32 col_a, u32 col_b, bool horizontal );
void imgui_draw_shadow( imgui_rect_t box, f32 spread, u32 col );
