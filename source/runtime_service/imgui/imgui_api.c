...
const imgui_api_t g_imgui_api_struct = 
{
    ...
    .viewport_update                    = imgui_viewport_update,
    .viewport_render_floaters           = imgui_viewport_render_floaters,
    ...
    .stack_same_line                    = imgui_stack_same_line,
    .skip                               = imgui_skip,
    ...
    .font_set_builtin                   = imgui_font_set_builtin,
    .font_set_bmp_scale                 = imgui_font_set_bmp_scale,
    .font_load_into                     = imgui_font_load_into,
    .font_use                           = imgui_font_use,
    ...
    .draw_check_mark                  = imgui_draw_check_mark,
    .draw_arrow                       = imgui_draw_arrow,
    .draw_bullet                      = imgui_draw_bullet,
    .draw_close                       = imgui_draw_close,
    .draw_arrow_pointing_at           = imgui_draw_arrow_pointing_at,
    .draw_chevron                     = imgui_draw_chevron,
    .draw_plus_minus                  = imgui_draw_plus_minus,
    .draw_frame                       = imgui_draw_frame,
    .draw_round_rect                  = imgui_draw_round_rect,
    .draw_ngon                        = imgui_draw_ngon,
    .draw_circle                      = imgui_draw_circle,
    .draw_arc                         = imgui_draw_arc,
    .draw_pie                         = imgui_draw_pie,
    .draw_bezier_quad                 = imgui_draw_bezier_quad,
    .draw_bezier_cubic                = imgui_draw_bezier_cubic,
    .draw_dashed_line                 = imgui_draw_dashed_line,
    .draw_checker                     = imgui_draw_checker,
    .draw_hatch                       = imgui_draw_hatch,
    .draw_gradient                    = imgui_draw_gradient,
    .draw_shadow                      = imgui_draw_shadow,
    .draw_text_outline                = imgui_draw_text_outline,
    .draw_text_shadow                 = imgui_draw_text_shadow,
    .draw_grip                        = imgui_draw_grip,
    .draw_spinner                     = imgui_draw_spinner,
    .draw_progress_arc                = imgui_draw_progress_arc,
    ...
    .set_retained_skip                  = imgui_render_set_retained_skip,
    .retained_skip                      = imgui_render_retained_skip,
