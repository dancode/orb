...
//  EXPORTED: C:\WINDOWS\FONTS\CONSOLA.TTF 12 consola_12.c
...
static bitmap_font_t s_bitmaps[ IMGUI_FONT_BITMAP_MAX ] = {
    ...
    [ IMGUI_FONT_BITMAP_16_CLEAN ]    = { .def = &s_def_16_clean },

    // built-in fonts  generated by font_tool.exe -*.c
    [ IMGUI_FONT_BITMAP_12_CONSOLA ]  = { .def = &s_def_consola_16 },
...
bitmap_atlas_init( bitmap_font_t* bf )
{
    ...
    ORB_ASSERT( def->atlas_w * def->atlas_h <= 256u * 128u );
    u8  pixels[ 256 * 128 ];
