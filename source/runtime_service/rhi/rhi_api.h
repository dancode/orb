...
typedef struct rhi_api_s
{
    ...
    void            ( *cmd_begin_rendering ) ( rhi_cmd_t cmd, const rhi_color_attachment_t* color_atts, u32 color_count, const rhi_depth_attachment_t* depth_att );
    ...
    void            ( *cmd_draw_indexed_indirect )( rhi_cmd_t cmd, rhi_buffer_t buf, u32 offset, 
