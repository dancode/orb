...
f32  gui_anim_time( void );
bool gui_anim_once( f32 t0, f32 duration, f32* out_rate, f32* out_phase );
void gui_draw_set_anim_curve( u32 curve, f32 param );
void gui_draw_set_anim_phase( f32 cycles );
f32  gui_draw_anim_phase( void );
...
void gui_draw_bezel( gui_rect_t box, u32 col_bg, u32 col_border, f32 border );
...
void gui_draw_round_frame_ex( gui_rect_t box, f32 r_tl, f32 r_tr, f32 r_br, f32 r_bl, u32 col_bg, u32 col_border, f32 border );
...
bool gui_slider_int( const char* label, i32* v, i32 lo, i32 hi, const char* format );
