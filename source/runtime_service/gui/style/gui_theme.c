...
/* Shared authoring blocks -- the built-in themes repeat large identical spans (the 5x4 palette,
   ...
   A palette is authored as the element grid itself -- role by role, four states across -- which
...
#define THEME_PALETTE_DARK \
    .col = { \
    /*                    IDLE                              HOT                               ACTIVE                            DIM                            */ \
    [ GUI_EL_PANEL  ] = { GUI_COLOR( 0x24,0x24,0x24,0xFF ), GUI_COLOR( 0x2A,0x30,0x38,0xFF ), GUI_COLOR( 0x10,0x60,0xA0,0xFF ), GUI_COLOR( 0x1C,0x1C,0x1C,0xFF ) }, \
    [ GUI_EL_BG     ] = { GUI_COLOR( 0x40,0x40,0x40,0xFF ), GUI_COLOR( 0x50,0x80,0xB0,0xFF ), GUI_COLOR( 0x30,0x60,0x90,0xFF ), GUI_COLOR( 0x30,0x30,0x30,0xFF ) }, \
    [ GUI_EL_BORDER ] = { GUI_COLOR( 0x80,0x80,0x80,0xFF ), GUI_COLOR( 0x40,0xA0,0xF0,0xFF ), GUI_COLOR( 0x40,0xA0,0xF0,0xFF ), GUI_COLOR( 0x50,0x50,0x50,0xFF ) }, \
    [ GUI_EL_TEXT   ] = { GUI_COLOR( 0xF0,0xF0,0xF0,0xFF ), GUI_COLOR( 0xF0,0xF0,0xF0,0xFF ), GUI_COLOR( 0xF0,0xF0,0xF0,0xFF ), GUI_COLOR( 0xA0,0xA0,0xA0,0xFF ) }, \
    [ GUI_EL_ACCENT ] = { GUI_COLOR( 0x20,0x90,0xD0,0xFF ), GUI_COLOR( 0x40,0xA0,0xF0,0xFF ), GUI_COLOR( 0x18,0xE6,0x48,0xFF ), GUI_COLOR( 0x30,0x30,0x30,0xFF ) }, \
    }
...
#define THEME_PALETTE_LIGHT \
    .col = { \
    /*                    IDLE                              HOT                               ACTIVE                            DIM                            */ \
    [ GUI_EL_PANEL  ] = { GUI_COLOR( 0xE2,0xE2,0xE6,0xFF ), GUI_COLOR( 0xAE,0xB4,0xC0,0xFF ), GUI_COLOR( 0x50,0x6C,0x94,0xFF ), GUI_COLOR( 0xD6,0xD7,0xDC,0xFF ) }, \
    [ GUI_EL_BG     ] = { GUI_COLOR( 0xEC,0xEC,0xF0,0xFF ), GUI_COLOR( 0x86,0xA6,0xD2,0xFF ), GUI_COLOR( 0x5C,0x82,0xB4,0xFF ), GUI_COLOR( 0xDC,0xDC,0xE2,0xFF ) }, \
    [ GUI_EL_BORDER ] = { GUI_COLOR( 0xB4,0xB5,0xBC,0xFF ), GUI_COLOR( 0x44,0x6C,0xA6,0xFF ), GUI_COLOR( 0x44,0x6C,0xA6,0xFF ), GUI_COLOR( 0xC8,0xC9,0xCF,0xFF ) }, \
    [ GUI_EL_TEXT   ] = { GUI_COLOR( 0x20,0x22,0x26,0xFF ), GUI_COLOR( 0x20,0x22,0x26,0xFF ), GUI_COLOR( 0x20,0x22,0x26,0xFF ), GUI_COLOR( 0x6C,0x6E,0x74,0xFF ) }, \
    [ GUI_EL_ACCENT ] = { GUI_COLOR( 0x44,0x6C,0xA6,0xFF ), GUI_COLOR( 0x44,0x6C,0xA6,0xFF ), GUI_COLOR( 0x2E,0x9E,0x54,0xFF ), GUI_COLOR( 0xC7,0xC8,0xCE,0xFF ) }, \
    }
...
/* The ACTIVE style -- s_style_base rescaled for the current font by gui_style_apply.  The
   internal read the stock unit's el_style_derive compiles from (see style/gui_style.h). */
const gui_style_t*
style_active( void )
{
    return &s_style;
