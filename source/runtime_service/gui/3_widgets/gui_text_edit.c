/*==============================================================================================
    ...
    runtime_service/gui/3_widgets/gui_text_edit.c -- Single-line text editing engine.
    ...
    blinking caret) -- all clipped to a caller-supplied box.  input_text (gui_widget.c) is a
...
/* 16 bytes -- fits within GUI_STATE_CAP. */
                  ...
                  gui_text_cb_fn on_change, void* cb_user )
{
    ...
    /* Accumulate the edit flag for is_item_deactivated_after_edit (5_user/gui_query.c). */
    if ( res.changed )
        mark_item_edited();
