/*==============================================================================================
    ...
    runtime_service/gui/3_widgets/gui_scrollbar.c -- Scrollbar: track + knob over a scroll offset.
    ...
    (2_interact/gui_item.c), so the bar never lists as a keyboard target (neither Tab nor the
    chrome lane).

    Included by gui.c in the 3_widgets/ tier; the region engine reaches it through the forward
