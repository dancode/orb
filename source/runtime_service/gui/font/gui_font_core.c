...
/* Intern a loaded font's resource name for its registry slot (gui_font_load.c) into the shared
   pool.  A dedicated accessor rather than reaching across for gui_names_intern directly,
...
/*==============================================================================================
    Name utilities -- how the resolver keys its memo.
==============================================================================================*/

/* Lowercase, alphanumeric-only copy of `s`, so two spellings of one family share a memo key
   regardless of spaces, case, or punctuation: "Cascadia Mono" == "CascadiaMono" ==
   "cascadia_mono". */
void
