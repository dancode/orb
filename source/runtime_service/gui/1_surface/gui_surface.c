/*==============================================================================================
    ...
    runtime_service/gui/1_surface/gui_surface.c -- The surface service: window records as
    ...
    Included by gui.c after 0_foundation/ and before 2_compose/ -- a root region enters the
...
/*----------------------------------------------------------------------------------------------
    ...
    detection that fills this slot is 4_window/ policy (window_begin_ex / the detach button);
