...
void draw_set_viewport          ( gui_vp_t vp );    // viewport stamped on new commands (surface routing)
...
extern gui_id_t g_dash_window_id;
    ...
    typedef struct                       /* gui_gpu_cmd_t + its parallel arrays, flattened */
    {
        ...
        gui_vp_t   vp;                   /* GUI_VP_INVALID = dormant volatile pad */
        gui_rect_t clip;
...
==============================================================================================*/
    ...
    typedef struct
    {
        ...
        gui_vp_t    vp;       /* owning segment's surface */
    ...
    typedef struct
    {
        ...
        gui_vp_t   vp;        /* the segment's surface */
