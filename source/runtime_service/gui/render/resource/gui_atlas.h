/*==============================================================================================
    ...
    RHI itself tracks neither the pairing nor the lifetime -- texture_create /
    ...
    sequence is written once.  The shared resource atlas (gui_res_atlas.c) composes one of these per
