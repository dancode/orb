/*==============================================================================================
    ...
    the cursor, so a window (gui_window_free.c), a resizeable child_begin (gui_layout_child.c),
    and a floating dock group (gui_dock_float.c) share one resize feel from here (the dock
    splitter is a gutter grab in dock/, not this mechanism).
    ...
    paint policy and lives with the skin (present/gui_paint_core.c: draw_resize_highlight);
    ...
    WIN_BORDER resolves from the foundation/gui_style.c vocabulary.
