/*==============================================================================================
    ...
    runtime_service/gui/interact/gui_state.c -- Keyed state pool: persistent per-id tracking.
    ...
    Included by gui.c after interact/gui_id.c (the identity service that mints the keys) --
    g_ctx / s_retained come from core/gui_ctx.c above both.
...
/* Animation utilities (gui_anim_f32, gui_anim_bg, ...) live in interact/gui_anim.c,
   included after core/gui_widget_core.c which provides the color palette they blend. */
