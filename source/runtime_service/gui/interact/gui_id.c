/*==============================================================================================
    ...
    runtime_service/gui/interact/gui_id.c -- Identity service: ID hashing, combining, scope stack.
    ...
    interact/gui_state.c, included immediately after this file.

    Included by gui.c after core/gui_ctx.c, which defines g_ctx (needed for s_retained /
...
/* The keyed state pool (gui_state_get / gui_state_peek / GUI_STATE) is the companion tracking
   service in interact/gui_state.c, included next. */
