/*==============================================================================================
    ...
    Makes the dock_root seam (gui_internal.h / gui_03_submit_render.c) live.  A viewport's dock_root is a
    ...
    How a docked window renders: window_begin_ex (gui_widget_window.c) detects a docked window via
    ...
    Included by gui.c AFTER gui_widget_window.c (so window_begin_docked / window_end can forward to
    dock_find_window_node + dock_window_chrome, declared in gui_internal.h) and before gui_popup.c.
