/*==============================================================================================
    ...
    gui_state_get and the GUI_STATE macro live here too: the keyed per-widget state pool
    ...
    Included by gui.c after gui_ctx.c, which defines g_ctx (needed for s_retained /
...
/* Animation utilities (gui_anim_f32, gui_anim_bg, ...) live in gui_anim.c,
   included after gui_widget_core.c which provides the color palette they blend. */
