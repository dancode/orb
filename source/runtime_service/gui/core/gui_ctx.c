...
/* The debug overlay (gui_04_debug_overlay.c) lives in the render backend unit and tags each captured rect
...
/* rect_intersect (rect overlap) is a shared geometry helper defined in gui.c, ahead of the
   unity includes, so gui_01_emit_draw.c can use it for clip intersection too. */
