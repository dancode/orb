...
typedef struct
{
    ...
    i32 mouse_viewport;        // surface the cursor is in (resolved from mouse-event win_id); persists
...
void pane_tag( gui_id_t id, u32 z, i32 vp, u32 band );   /* defined frame/gui_pane.c */
