/*==============================================================================================
    ...
    runtime_service/gui/5_user/gui_canvas.c -- Custom-draw / canvas surface of the user tier.
...
/* Volatile widgets (gui()->volatile_cb / volatile_begin / volatile_end) live in their own file --
   3_widgets/gui_volatile.c -- rather than here, since they're a distinct cross-cutting feature
