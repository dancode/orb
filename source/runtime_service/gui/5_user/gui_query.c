/*==============================================================================================
    ...
    runtime_service/gui/5_user/gui_query.c -- Public readers over the io + interaction services.
    ...
    machinery (0_foundation/gui_io.c snapshot, 2_interact/gui_item.c last-item latch) stays with the
...
/* True when gui owns the keyboard this frame -- a text field is focused, keyboard nav is engaged,
   or a 4_popup/menu is open -- so gameplay / tools must not also act on the same keystrokes (an arrow
