/*==============================================================================================
    ...
    runtime_service/gui/chrome/window/gui_window_end.c -- Deferred window chrome (gui_window_end).
...
/* Trial trace shadow under the title bar -- draw_edge_shadow's first fitting, gated on the same
