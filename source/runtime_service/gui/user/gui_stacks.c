/*==============================================================================================
    ...
    The thin public wrappers for the three push / pop / next stacks a caller brackets widgets with:
        push_id / pop_id           -- id-scope levels for repeated widgets (id stack, foundation/gui_id.c)
        push_item_flag / next_     -- per-item behavior tweaks (item-flag stack, foundation/gui_ctx.c)
        push_style_color / _var    -- per-item theme overrides (style stacks, foundation/gui_style.c)
    ...
    live with foundation/; the verbs a user speaks live here).  Nothing in the lib below
