...
const gui_api_t g_gui_api_struct =
{
    ...
    .register_shape                     = gui_register_shape,
    .find_shape                         = gui_find_shape,
    .shape_size                         = gui_shape_size,
    .shape_reach                        = gui_shape_reach,
    .draw_set_shape                     = gui_draw_set_shape,
    .draw_shape_in                      = gui_draw_shape_in,
    ...
    .draw_get_text_edge                 = gui_draw_get_text_edge,
    ...
    .draw_meter                         = gui_draw_meter,
    .draw_rect_cut                      = gui_draw_rect_cut,
