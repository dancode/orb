...
const gui_api_t g_gui_api_struct =
{
    ...
    .push_style_color_look              = gui_push_style_color_look,
    .next_style_color_look              = gui_next_style_color_look,
    ...
    .push_style_face_look               = gui_push_style_face_look,
    .style_face                         = gui_style_face,
    .style_face_look                    = gui_style_face_look,
    .draw_face                          = gui_draw_face,
    .draw_face_look                     = gui_draw_face_look,
