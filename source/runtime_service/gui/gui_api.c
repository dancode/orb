...
const gui_api_t g_gui_api_struct = 
{
    ...
    .row_gap                            = gui_row_gap,
    .rows_h                             = gui_rows_h,
    .adv_line_h                         = gui_adv_line_h,
    .adv_text_w                         = gui_adv_text_w,
    .adv_text_h                         = gui_adv_text_h,
    .adv_h_min                          = gui_adv_h_min,
    .adv_w_min                          = gui_adv_w_min,
    .adv_calc_row                       = gui_adv_calc_row,
    .adv_calc_col                       = gui_adv_calc_col,
