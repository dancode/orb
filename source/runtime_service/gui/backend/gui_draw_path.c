/*==============================================================================================
    ...
    runtime_service/gui/gui_draw_path.c -- Line and path stroking.

    Builds antialiased / pixel-snapped stroke geometry on top of the raw draw-list reservation
    (draw_prim_begin in gui_draw.c).  Two layers:
    ...
    Included by gui_backend.c immediately after gui_draw.c (uses s_draw, draw_prim_begin/commit,
