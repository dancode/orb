/*==============================================================================================
    ...
    runtime_service/gui/backend/gui_04_debug_overlay.c -- Bolt-on debug overlay.
    ...
    Included by gui_backend.c last, after gui_03_submit_render.c so s_render, render_ortho, gui_push_t,
