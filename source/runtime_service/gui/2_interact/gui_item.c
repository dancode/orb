/*==============================================================================================
    ...
    runtime_service/gui/2_interact/gui_item.c -- The standard item protocol.

    widget_behavior: the default COMPOSITION of the interaction services, run once per item
    over a finished rect.  Every stock widget, chrome control, and gui_item() (5_user/) obtains
