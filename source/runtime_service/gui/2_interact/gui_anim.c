/*==============================================================================================
    ...
    (2_present/gui_widget_core.c: widget_bg_color_anim), the size ease with the layout engine
    (2_compose/gui_layout_core.c: size_animate).
    ...
    Included by gui.c after the 2_compose/ files; earlier callers reach it through the forward
