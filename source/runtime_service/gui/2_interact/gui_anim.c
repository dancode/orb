/*==============================================================================================
    ...
    runtime_service/gui/2_interact/gui_anim.c -- Animation stepping service.
    ...
    Storage lives in the keyed state pool (0_foundation/gui_state.c) with peek-then-stamp semantics:
    ...
    Included by gui.c after gui_widget_core.c (COL_*, col_lerp, widget_state_t) and
    before gui_widget.c (which calls into this).
...
/*----------------------------------------------------------------------------------------------
    gui_anim_bg -- hover/active background blend for button-like widgets
...
static u32
gui_anim_bg( gui_id_t id, widget_state_t st )
{
