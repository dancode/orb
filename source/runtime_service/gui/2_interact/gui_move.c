/*==============================================================================================
    ...
    runtime_service/gui/2_interact/gui_move.c -- Move-drag and deferred-press protocols.
    ...
    Included by gui.c with the other 2_interact services, after gui_item.c; consumers are the
    tier-4 hosts (gui_widget_window.c, gui_dock_drag.c, gui_dock_float.c) and the frame
