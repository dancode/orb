/*==============================================================================================
    ...
    runtime_service/gui/4_window/gui_window_native.c -- Native-borderless windows (GUI_WIN_NATIVE).
    ...
    gui_widget_window.c (window_begin_ex / window_end, which call everything here).
...
/* Enqueue a button-triggered tear-off or merge-back into the one-shot s_vp_request slot
   (1_surface/gui_surface.c) -- shared by the pop-in caption button here and the plain detach
