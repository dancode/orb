/*==============================================================================================
    ...
    of their own: memory stats, the animation-state query, the multi-context lifecycle
    (ctx_create/destroy/bind/set_listening), and the gui-owned floater surfaces (viewport_spawn /
    update / render_floaters).  The perf / state HUD overlays and the frame-timing helpers the
    lifecycle here calls live in gui_frame_overlay.c, included just before this file.
