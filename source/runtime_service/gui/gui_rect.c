/*==============================================================================================
    ...
    * The bottom of the gui stack. 
    * Pure geometry + color primitives with no dependency beyond base types. 
        * No draw, no ids, no ambient state -- usable by any 2d utility, inside gui or out.
    * The inline kit (types + carve algebra) is rect/gui_rect.h;
