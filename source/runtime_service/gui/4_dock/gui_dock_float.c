/*==============================================================================================
    ...
    runtime_service/gui/4_dock/gui_dock_float.c -- Floating tab groups: windows sharing one frame.
    ...
    dock_float_resolve / dock_float_service_request are forward-declared in gui_internal.h for
    gui_widget_window.c, included earlier.
...
/* Keep the group reachable, mirroring window_clamp: the strip may not slide under the host's
   native caption band or fully off the surface. */
static void
