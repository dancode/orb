/*==============================================================================================
    ...
    runtime_service/gui/4_dock/gui_dock_core.c -- Dock-node tree: pool, layout, splitter chrome.
    ...
    primitives and lives in the sibling 4_dock/ files, included after this one.

    Included by gui.c first among the 4_dock/ files: dock_node_alloc / _free / _find /
