/*==============================================================================================
    ...
    runtime_service/gui/0_foundation/gui_style.c -- Style stacks: colors + layout metrics.
    ...
    s_style (0_foundation/gui_theme.c) and GUI_COLOR (gui.h) are already visible.
