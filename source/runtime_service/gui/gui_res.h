...
/*==============================================================================================
    ...
    Every file gui loads -- a font bake, an icon or sprite image, its own cooked shaders -- is a
    resource NAME (engine/res/res.h) plus the extension the loader accepts, read through the
    fs mounts.  gui holds no root of its own: which directory, cooked mirror, or pack answers a
    name is the host's mount table (run_host mounts content/ and build/content; the gui boot
