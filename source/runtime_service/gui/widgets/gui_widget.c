/*==============================================================================================
    ...
    and behavior on caller rects (gui_item, invisible_button) are the user/ tier
    ...
    Included by gui.c after core/gui_widget_core.c + interact/gui_item.c so widget_behavior,
