/*==============================================================================================
    ...
    (example_reflect.generated.c) defines example_reflect_rs_register(); the function
    pointer is passed to the mod system via the descriptor's rs_register slot, and the
