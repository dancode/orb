...
#include "base/orb.h"              // general project settings and declarations
#include "engine/module/module.h"    // module system (boot, load/unload, tick, shutdown)
...
#include "engine/sys/sys_api.h" /* change name? ew */
...
/* Tier 2 headers included only so module_load() macro can resolve the getter names
   in ORB_BUILD_STATIC.  Their API functions are NOT called from main(). */
