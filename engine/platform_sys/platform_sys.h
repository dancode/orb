...
/*==============================================================================================
    ...
    platform sys api : the API that platform_sys exposes to modules.
...
/*==============================================================================================
    ...
    sys file : file time, copy, delete, exe dir
...
/*==============================================================================================
    ...
    Platform-agnostic non-blocking directory watcher.
    ...
    Threading
    ---------
    All functions must be called from the same thread.  The implementation
    uses non-blocking overlapped I/O (Windows) or non-blocking inotify (Linux)
    so poll() returns immediately when nothing has changed.
...
/*==============================================================================================
    ...
    It is intentionally not the same thing as platform_app input.
